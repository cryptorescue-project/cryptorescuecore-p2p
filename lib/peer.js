 ...
 * using the standard CryptoRescue protocol. A Peer instance represents one connection
 * on the CryptoRescue network. To create a new peer connection provide the host and port
