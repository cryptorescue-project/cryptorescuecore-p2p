...
function builder(options) {
  ...
  if (!options.network) {
    options.network = cryptorescuecore.Networks.defaultNetwork;
  }

  options.Block = options.Block || cryptorescuecore.Block;
  options.BlockHeader = options.BlockHeader || cryptorescuecore.BlockHeader;
  options.Transaction = options.Transaction || cryptorescuecore.Transaction;
  options.MerkleBlock = options.MerkleBlock || cryptorescuecore.MerkleBlock;
