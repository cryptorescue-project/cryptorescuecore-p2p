...
var Hash = cryptorescuecore.crypto.Hash;
var $ = cryptorescuecore.util.preconditions;

/**
 * A factory to build CryptoRescue protocol messages.
...
function Messages(options) {
  ...
  this.network = options.network || cryptorescuecore.Networks.defaultNetwork;
}
